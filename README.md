# how-to-run-ASUS-VivoBook-X515JAB-board-outside-laptop
...
* For enableing chargeing you need to short the chargeing detect pin to ground. You dont need to do this if you are going to use original charger. 

![Bez názvu 3](https://github.com/0rqa/how-to-run-ASUS-VivoBook-X515JAB-board-outside-laptop/blob/main/power_plug.png)

<br>

* For turning the board on you can short test point near the KB flex cable connector to ground.
